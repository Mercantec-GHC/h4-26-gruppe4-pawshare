        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Animals_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Animals_Appointments_AppointmentId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RealPassword = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Base64Pfp = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPostAcceptance", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPostAcceptance_Posts_PostId1",
                        column: x => x.PostId1,
                        principalTable: "Posts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserPostAcceptance_Users_UserId1",
                        column: x => x.UserId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Animals_AppointmentId",
                table: "Animals",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Animals_AppointmentId1",
                table: "Animals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPostAcceptance_PostId1",
                table: "UserPostAcceptance",
                column: "PostId1");

            migrationBuilder.CreateIndex(
                name: "IX_UserPostAcceptance_UserId1",
                table: "UserPostAcceptance",
                column: "UserId1");
